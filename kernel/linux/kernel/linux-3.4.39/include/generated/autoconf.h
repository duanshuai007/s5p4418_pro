...
#define CONFIG_CMDLINE "console=ttyAMA0,115200n8 root=/dev/mmcblk0p2 rootfstype=ext4 rootdelay=1 initrd=0x49000000,0x1000000 init=/init"
...
#define CONFIG_S5P4418_MEM_MAX_ORDER_13 1
...
#define CONFIG_SERIAL_NXP_S3C_UARTS 6
